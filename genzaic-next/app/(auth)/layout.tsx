...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="h-dvh flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[48%] xl:w-[52%] relative flex-col justify-between overflow-hidden"
        style={{ background: "linear-gradient(145deg, #1a1030 0%, #2d1b69 35%, #4c1d95 65%, #7c3aed 100%)" }}
      >
        ...
        <div className="relative z-10 px-8 xl:px-12 flex-1 flex flex-col justify-center">
          ...
          <p className="text-violet-200/70 text-sm xl:text-base max-w-md leading-relaxed mb-8">
            Sell PDFs, templates, code & digital products. UPI-ready, GST-ready — zero setup fees.
          </p>
          ...
          <div className="flex gap-8 mb-10">
            {[
              ...
              <div key={stat.label}>
                ...
                <p className="text-violet-300/60 text-xs mt-0.5">{stat.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white/[0.07] backdrop-blur-sm rounded-2xl border border-white/[0.08] p-5 max-w-md">
            ...
            <p className="text-white/80 text-sm leading-relaxed mb-4">
              &ldquo;GenZaic made it incredibly easy to start selling my design templates. The UPI integration and auto GST invoicing saved me hours of work every week.&rdquo;
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-violet-300/50 text-xs">Design Template Creator</p>
              </div>
            </div>
          </div>
        </div>
