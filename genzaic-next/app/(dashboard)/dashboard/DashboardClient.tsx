...
export function DashboardClient({ firstName }: DashboardClientProps) {
  // These three queries are pre-seeded by the server-side HydrationBoundary in
  // page.tsx — first render reads from cache with zero network round-trips.
  // They remain `useQuery` so the client can revalidate on focus / interval.
