...
const trustBadges = [
  { icon: ShieldCheck, title: "SSL Secured", desc: "256-bit encryption on all transactions", color: "text-emerald-400", bg: "bg-emerald-400/10" },
  { icon: BadgeCheck, title: "GSTIN Verified", desc: "Tax-compliant registered business", color: "text-blue-400", bg: "bg-blue-400/10" },
  { icon: Headphones, title: "Creator Support", desc: "Dedicated help for all sellers", color: "text-amber-400", bg: "bg-amber-400/10" },
  { icon: Download, title: "Instant Delivery", desc: "Secure download links on purchase", color: "text-violet-400", bg: "bg-violet-400/10" },
]
            ...
            {trustBadges.map((badge, i) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-gray-500 leading-tight mt-0.5 hidden sm:block">{badge.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between text-xs text-gray-500">
            <div className="flex flex-col items-center gap-1.5 sm:flex-row sm:gap-0">
              <span>&copy; {new Date().getFullYear()} GenZaic. All rights reserved.</span>
              <span className="hidden sm:inline mx-1.5 text-gray-700">&bull;</span>
