...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "order_access_tokens_order_id_idx" ON "order_access_tokens" USING btree ("order_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "order_access_tokens_expires_at_idx" ON "order_access_tokens" USING btree ("expires_at");
