...
const AuthLayout = ({ children, title, subtitle }: AuthLayoutProps) => {
  return (
    <div className="flex min-h-screen">
          ...
          <div className="space-y-6">
            ...
            >
              <h2 className="font-display text-4xl font-bold text-white leading-tight">
                ...
                <br />a digital business
              </h2>
              <p className="text-white/70 text-lg mt-4 max-w-md">
                Sell digital products with auto GST invoicing and fast payouts.
                Zero setup fee to get started.
              </p>
            </motion.div>
      ...
      {/* Right Panel - Form */}
      <div className="w-full lg:w-1/2 flex justify-center p-8 bg-background">
        <motion.div
