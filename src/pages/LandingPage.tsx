        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              variant="outline"
            >
              <Link to="/signup?role=buyer">Sign up as Buyer</Link>
            </Button>
            <Button
              asChild
              className="gradient-primary hover:opacity-90 transition-opacity"
            >
              <Link to="/signup?role=seller">Sell on GenZaic</Link>
            </Button>
          </div>
        </div>
      </nav>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="lg"
                asChild
                className="gradient-primary hover:opacity-90 transition-opacity text-lg px-8 h-14"
              >
                <Link to="/signup">
                  Start Selling Today
              ...
              <div className="p-8 bg-gradient-to-br from-background to-accent/30 min-h-[300px] flex items-center justify-center">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl">
                  {[
                    ...
                    >
                      <div
                        className={`h-24 ${product.color} rounded-lg mb-3`}
                      />
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Everything you need to run a professional digital business in
              India.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Secure KYC",
                description:
                  "Bank-grade verification with PAN & bank account validation.",
              },
              {
                icon: FileText,
                title: "Auto GST Invoicing",
                description:
                  "Compliant invoices generated automatically for every sale.",
              },
              {
                icon: CreditCard,
                title: "Indian Payments",
                description:
                  "UPI, credit/debit cards, net banking, and wallet support.",
              },
              {
                icon: Zap,
                title: "Instant Delivery",
                description:
                  "Automatic file delivery with secure download links.",
              },
              {
                icon: Globe,
              ...
              },
              {
                ...
                description:
                  "Reliable payouts to your bank account within one week.",
              },
              {
                icon: Globe,
              ...
              },
              {
                ...
                description:
                  "Build trust with ratings and reviews on your products.",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
      ...
      >
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Get your digital products online and start earning in minutes, not
              days.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Add your digital products — PDFs, templates, code, designs. Set your price in INR.",
                color: "gradient-card-1",
                step: "01",
              },
              {
                ...
                description:
                  "Choose from beautiful pre-built themes. Your store is mobile-ready instantly.",
                color: "gradient-card-2",
                step: "02",
              },
              {
                ...
                description:
                  "Accept UPI, cards, wallets. Auto GST invoicing. T+1 payouts to your bank.",
                color: "gradient-card-3",
                step: "03",
              },
            ].map((item, i) => (
              ...
              >
                <div className="bg-card rounded-2xl p-8 border border-border shadow-md hover:shadow-lg transition-shadow h-full">
                  ...
                  <div
                    className={`w-14 h-14 ${item.color} rounded-xl flex items-center justify-center mb-6 mt-4`}
                  >
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-success/10 border border-success/30 mb-6">
              ...
              <span className="text-sm font-bold text-success">
                Our USP — Zero Risk, Maximum Reward
              </span>
            </div>
            <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">
              Start for <span className="text-success">₹0</span> — Pay Only When
              You Earn
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              No hidden fees. No monthly charges. We only succeed when you
              succeed.
            </p>
          </motion.div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-card rounded-3xl border-2 border-success/50 shadow-2xl overflow-hidden">
                ...
                <div className="px-8 py-12 text-center border-b border-border">
                  <span className="text-7xl md:text-9xl font-display font-bold text-success">
                    ₹0
                  </span>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
              Discover and sell digital products in India's first
              creator-focused marketplace. Get discovered by millions of
              potential buyers.
            </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Get discovered by buyers searching for digital products.",
                  },
                  {
                    icon: Sparkles,
